...
python codebase/main.py --data_path data/cifar10 --log_file logs/06-21/cifar10.log --im_file data/cifar10/val.hdf5 --out_file out/06-21/cifar10.log --optimizer adagrad --n_epochs 5 --init_scale .1 --n_kernels 64 --learning_rate 1. --n_modules 5 --generator fast_gradient
