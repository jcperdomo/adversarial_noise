...
python codebase/main.py --data_path data/cifar10 --log_file logs/$DATE/cifar10.log --im_file data/cifar10/te.hdf5 --out_file out/$DATE/cifar10.hdf5 --optimizer adagrad --n_epochs 20 --init_scale .1 --n_kernels 128 --learning_rate 1. --n_modules 5 --generator fast_gradient --eps 1.
