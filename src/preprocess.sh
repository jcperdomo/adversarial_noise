...
python src/codebase_pytorch/utils/quick_process.py --data_path /n/regal/rush_lab/awang/raw_data/imagenet/images/ --out_path /n/regal/rush_lab/awang/processed_data/imagenet_test/ --n_class_ims 10
